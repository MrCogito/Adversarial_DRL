...
bsub -o "outputs/Test32/Markdown/Test32_0.md" -J "Test32_0" -env MYARGS="-name Test32-0 -time 84600 -epochs 1000 -batch_size 32 -isServer True -gamma 99.0 -ID 0" < submit_gpu_v32.sh
