...
import numpy as np
import torch
from Adversarial_DRL.training import Opponent, transform_and_flip
...
if __name__ == "__main__":
    ...
    path = "/zhome/59/9/198225/Desktop/Adversarial_DRL/Adversarial_DRL/epoch_600_models/DQN/v100AdvLowLr_.pt"  # Path to saved agent checkpoint
    path_trained = "/zhome/59/9/198225/Desktop/Adversarial_DRL/Adversarial_DRL/epoch_6000_models/DQN/v1002VictimLowLRs_.pt"
    ...
    dqn_trained.loadCheckpoint(path_trained)
    ...
    for opponent_difficulty in ["random", "weak", "strong", "self"]:
        ...
        gif_path = "/zhome/59/9/198225/Desktop/Adversarial_DRL/Adversarial_DRL/videosAdv"
        os.makedirs(gif_path, exist_ok=True)
        imageio.mimwrite(
            os.path.join("/zhome/59/9/198225/Desktop/Adversarial_DRL/Adversarial_DRL/videosAdv", f"connect_four_{opponent_difficulty}_opp.gif"),
            frames,
            duration=400,
            loop=True,
        )
